 ...
 *
 * @file
 * @brief       Implementation of STM32 clock configuration for F0/F1/F2/F3/F4/F7 families TODO
 *
...
#define PLL_M                       (CONFIG_CLOCK_PLL_M << RCC_PLLCFGR_PLL2RGE_Pos)
#define PLL_N                       (CONFIG_CLOCK_PLL_N << RCC_PLLCFGR_PLL2RGE_Pos)
#define PLL_P                       (((CONFIG_CLOCK_PLL_P / 2) - 1) << RCC_PLLCFGR_PLL2RGE_Pos)
#define PLL_Q                       (CONFIG_CLOCK_PLL_Q << RCC_PLLCFGR_PLL2RGE_Pos)
...
#define CLOCK_APB1_DIV              (RCC_D1CFGR_PPRE1_DIV1)
#elif CONFIG_CLOCK_APB1_DIV == 2
#define CLOCK_APB1_DIV              (RCC_D1CFGR_PPRE1_DIV2)
#elif CONFIG_CLOCK_APB1_DIV == 4
#define CLOCK_APB1_DIV              (RCC_D1CFGR_HPRE_DIV4)
#elif CONFIG_CLOCK_APB1_DIV == 8
#define CLOCK_APB1_DIV              (RCC_D1CFGR_PPRE1_DIV8)
#elif CONFIG_CLOCK_APB1_DIV == 16
#define CLOCK_APB1_DIV              (RCC_D1CFGR_PPRE1_DIV16)
#else
...
#define CLOCK_APB2_DIV              (RCC_D1CFGR_HPRE_DIV2)
...
return;
    ...
    RCC->CR = (RCC_CR_HSION | RCC_CR_HSIDIV_4);
